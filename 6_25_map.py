...
def main(): 
    ...
    # #define bounding box coord for stations 1 - 3 [oceanside]
    # north_a, south_a, east_a, west_a = 33.3, 33.18, -117.37, -117.5

    # #define bounding box coord for stations 4 - 9 [san diego]
    # north_b, south_b, east_b, west_b = 32.75, 32.5, -117.4, -117.28 

    #clip the coastline
    clipped_coastline = clipToBoundingBox(coastline, north, south, east, west)

    # clipped_coastline_a = clipToBoundingBox(coastline, north_a, south_a, east_a, west_a) 
    # clipped_coastline_b = clipToBoundingBox(coastline, north_b, south_b, east_b, west_b) 
