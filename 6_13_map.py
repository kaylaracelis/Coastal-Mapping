...
def main(): 
    ...
    north, south, east, west = 33.3, 32.5, -117.0, -117.5
...
def plotStations(ax, stations, abbreviations): 
    ...
    for label, point in stations.items(): 
        ...
        ax.plot(point.x, point.y, 'go', markersize = 3, label = f"{abbreviation} ({label})") #bo is blue
        ax.text(point.x, point.y, abbreviation, fontsize = 5, ha = 'right')
